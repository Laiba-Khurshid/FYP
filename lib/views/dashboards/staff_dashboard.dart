...
class _TeacherDashboardState extends State<TeacherDashboard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: Text('Teacher Dashboard', style: AppStyles.heading4()),
        actions: [
          // ============================================================
      ...
      body: RefreshIndicator(
        ...
        child: user == null
          ...
          children: [
            _TeacherWelcomeHeader(user: user),
...
/// Welcome section shown at the top of the Teacher dashboard: avatar,
/// name, today's date, and department.
class _TeacherWelcomeHeader extends StatelessWidget {
  final dynamic user;

  const _TeacherWelcomeHeader({required this.user});
        ...
        children: [
          CircleAvatar(
            ...
            child: (user.profileImage == null || (user.profileImage as String).isEmpty)
                ? Text(
              (user.fullName as String).isNotEmpty ? (user.fullName as String)[0].toUpperCase() : 'T',
